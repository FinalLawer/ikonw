...
public class InfinityOutputterScreen extends UpgradeableScreen<InfinityOutputterMenu> {
    ...
    private final Button faceBtn;

    public InfinityOutputterScreen(InfinityOutputterMenu menu, Inventory playerInventory, Component title,
            ScreenStyle style) {
        ...
        // 输出面切换按钮（左工具栏）
        this.faceBtn = Button.builder(Component.translatable("button.iknow.outputter_face"), b -> this.menu.cycleOutputFacing())
                .bounds(0, 0, 76, 18)
                .build();
        this.addToLeftToolbar(this.faceBtn);
    }
    ...
    protected void updateBeforeRender() {
        ...
        this.faceBtn.setMessage(Component.translatable("button.iknow.outputter_face")
                .append(": ").append(Component.literal(this.menu.getOutputFacing().getName())));
    }
}
